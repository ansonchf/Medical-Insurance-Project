# Python Control Flow (Input): Medical Insurance Project
...
# Input of the person
name1 = input('Hello I am here to help you to calculate the insurance cost, could you please enter your name?')
age1 = input('Could you please enter your age?')
sex1 = input('Could you please enter your sex? Type 0 for female, 1 for male')
bmi1 = input('Could you please enter your bmi?')
num_of_children1 = input('Could you please enter your number of children?')
smoker1 = input('Could you please enter your smoking status? Type 0 for non-smoker, 1 for smoker')

estimate_insurance_cost(name1, int(age1), int(sex1), float(bmi1), int(num_of_children1), int(smoker1))